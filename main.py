...
def new_fc_layer(parameters,
                 in_vector,         # The previous Layer
    ...
    if layer_number==0 and len(parameters['Hyperparameters']['Specify Parameters']) != 0:
        for spec in parameters['Hyperparameters']['Specified Parameters Initialisation']:
...
def fc_layers(parameters, input_for_first_fc_layer, num_inputs_for_first_fc_layer):
    # Define fully connected layers
    hidden_layer_size = parameters['Hyperparameters']['Hidden Layer Size']
    ...
    for i in range(num_hidden_layers):
        ...
        hidden_layers[i] = new_fc_layer(parameters,
                                        hidden_input,
                                        hidden_input_size,
                                        hidden_layer_size[i],
                                        activation_function=parameters['Hyperparameters']['Activation Functions'][i],
                                        init_type=parameters['Hyperparameters']['Initialisation Type'],
                                        layer_number=i)
    ...
    img_size = parameters['Imaging']['Image Size in Pixels']
    img_size_flat = img_size * img_size
    output = new_fc_layer(parameters,
                          penultimate_layer,
